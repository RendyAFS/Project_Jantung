...
print(f"Mean Jarak S1-S1:{sum(s1_values[i] - s1_values[i-1] for i in range(1, len(s1_values)))} / {len(s1_values) - 1} = {mean_s1_distance}")
...
print(f"Mean Jarak S2-S2:{sum(s2_values[i] - s2_values[i-1] for i in range(1, len(s2_values)))} / {len(s2_values) - 1} = {mean_s12_distance}")
...
print(f"Mean Jarak S1-S2:{sum(s2_values[i] - s1_values[i-1] for i in range(len(s2_values)))} / {len(s2_values)} = {mean_s2_distance}")